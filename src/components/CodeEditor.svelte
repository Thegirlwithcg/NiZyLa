    ...
    return EditorState.create({
      ...
      extensions: [
        ...
        EditorView.theme({
          ...
          '.cm-activeLine': { backgroundColor: 'color-mix(in srgb, var(--active-line) 55%, transparent)' },
          '.cm-activeLineGutter': { backgroundColor: 'color-mix(in srgb, var(--active-line) 55%, transparent)' },
